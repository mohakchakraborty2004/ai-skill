    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center font-sans p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#050505] border border-[#1a1a1a] rounded-2xl shadow-2xl p-8 relative overflow-hidden">
          ...
          <h2 className="text-2xl font-bold text-white mb-1 tracking-wide relative z-10">Welcome back</h2>
          <p className="text-gray-500 mb-8 text-sm relative z-10">Sign in to continue to your dashboard.</p>
          ...
          <p className="text-gray-500 text-sm text-center mt-6 relative z-10">
            ...
            <Link href="/signup" className="text-[#b026ff] hover:text-[#9015d8] font-semibold transition-colors">
              Sign up
            </Link>
          </p>
        </div>
